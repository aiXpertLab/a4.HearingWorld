...
import seeingvoice.jskj.com.seeingvoice.l_audiometry.verbaltests.VerbalTestResultL;
import seeingvoice.jskj.com.seeingvoice.l_audiometry.verbaltests.services.WhiteNoiseService;
 ...
 * auther:zyy
 */
public class NumKeyboardL extends MyTopBar {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        setToolBarMenuTwo("", R.mipmap.jiaocheng, new OnMenuClickListener() {
            ...
            public void onMultiClick(MenuItem v) {
                toNextActivity(null, NumKeyboardL.this, L_AboutUs.class);
            }
        });
        /** 从数据持久化中得到  设置好的音量值*/
        ...
        mHandler = new Handler(Looper.getMainLooper()){
            ...
            public void handleMessage(Message msg) {
                switch (msg.what){
                    ...
                    case 0x0001:
                        ...
                        if (testNo < testTotalNo) {//测试正在进行中
                            ...
                            if (isPractice == 1){//言语测试练习
                                playWhiteNoise.stop();
                                finish();
                                Intent mIntent = new Intent(NumKeyboardL.this, VP_FG_L.class);
                                mIntent.putExtra("restart","0x0009");
                                startActivity(mIntent);
                            }else if (isPractice == 0){//正式言语测试
                                Intent intent = new Intent(NumKeyboardL.this, VerbalTestResultL.class);
                    ...
                    case 0x0002:
                        playWhiteNoise.play(NumKeyboardL.this);
                        setWhiteNoiseVolumn();
                        params = new Bundle();
...
//                Toast.makeText(NumKeyboardActivity.this,"没听清，再播放一次！", Toast.LENGTH_SHORT).show();
    ...
    private void bingWhiteNoiseService() {
        ...
        intent.setClass(NumKeyboardL.this,WhiteNoiseService.class);
        /** 绑定白噪音服务*/
    ...
    private void initTTS() {
        mTextToSpeech = new TextToSpeech(NumKeyboardL.this, new TextToSpeech.OnInitListener() {
            @Override
    ...
    private void displayToast(String s) {
        Toast.makeText(NumKeyboardL.this,s,Toast.LENGTH_SHORT).show();
    }
