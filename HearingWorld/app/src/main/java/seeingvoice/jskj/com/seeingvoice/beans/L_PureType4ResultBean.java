 ...
 */
public class L_PureType4ResultBean implements Parcelable {
    ...
    public L_PureType4ResultBean(int user_id, String user_IMEI, String timeStamp, String l_average, String r_average, String remark, List<String> l_result, List<String> r_result) {
    ...
    private L_PureType4ResultBean(Parcel in) {
        user_id = in.readInt();
    ...
    public static final Creator<L_PureType4ResultBean> CREATOR = new Creator<L_PureType4ResultBean>() {
        @Override
        public L_PureType4ResultBean createFromParcel(Parcel in) {
            return new L_PureType4ResultBean(in);
        }

        @Override
        public L_PureType4ResultBean[] newArray(int size) {
            return new L_PureType4ResultBean[size];
        }
    };
