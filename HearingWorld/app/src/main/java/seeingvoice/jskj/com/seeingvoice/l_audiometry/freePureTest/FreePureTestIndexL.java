package seeingvoice.jskj.com.seeingvoice.l_audiometry.freePureTest;
...
public class FreePureTestIndexL extends MyTopBar {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        setToolBarMenuTwo("", R.mipmap.jiaocheng, new OnMenuClickListener() {
            ...
            public void onMultiClick(MenuItem v) {
                toNextActivity(null, FreePureTestIndexL.this, L_AboutUs.class);
            }
        });
