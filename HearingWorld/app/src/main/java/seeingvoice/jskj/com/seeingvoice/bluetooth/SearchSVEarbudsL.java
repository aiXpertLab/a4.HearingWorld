...
import static seeingvoice.jskj.com.seeingvoice.MyData.REQUEST_ENABLE_BT;
import static seeingvoice.jskj.com.seeingvoice.MyData.SCAN_PERIOD;
...
//    private String[] BlueHeadSetSupported = {"X-I8S","TicPods Free","W.mp","Hi-TWS R","Hi-TWS L","C7B","Hi-TWS","X8"};
    ...
    private void initBluetooth() {
        ...
        if (mBluetoothManager != null && mBluetoothManager.isSupportBluetooth()){//如果手机支持蓝牙功能，则获得蓝牙适配器对象
            mBluetoothManager.initBlueProfileA2dpHeadSet(SearchSVEarbudsL.this);
...
//    }
    ...
    public void deviceConnected(BluetoothDevice bluetoothDevice) {
        if (bluetoothDevice != null) {
            ...
            ActivityStackManager.getActivityStackManager().popActivity(SearchSVEarbudsL.this);
        }
    }
