...
//import seeingvoice.jskj.com.seeingvoice.permissions.PermissionsActivity;
//import seeingvoice.jskj.com.seeingvoice.PermissionsChecker;
...
//
//import static seeingvoice.jskj.com.seeingvoice.AppConstant.LOGIN_URL;
//import static seeingvoice.jskj.com.seeingvoice.AppConstant.NET_STATE_SUCCESS;
//import static seeingvoice.jskj.com.seeingvoice.AppConstant.PHONE_LOGIN;
//import static seeingvoice.jskj.com.seeingvoice.AppConstant.QQ_APP_ID;
//import static seeingvoice.jskj.com.seeingvoice.AppConstant.QQ_LOGIN;
//import static seeingvoice.jskj.com.seeingvoice.AppConstant.QQ_LOGIN_SEND_OPEN_ID;
//import static seeingvoice.jskj.com.seeingvoice.permissions.PermissionsActivity.PERMISSIONS_GRANTED;
//
///**
// * Date:2019/5/7
// * Time:15:45
...
//    private TextView mTvRegister,tv_find_psw,tv_notice,tv_user_agreement,tv_privacy_policy;//返回键,显示的注册，找回密码
...
//            @Override
//            public void onMultiClick(View v) {
//                toNextActivity(null,LoginActivity1.this, privacyPolicyActivity.class);
//            }
//        });
//
//        //登录按钮的点击事件
...
//                                ToastUtil.showLongToast("登陆失败："+request.toString()+"异常："+e.toString());
//                            }
//                            @Override
