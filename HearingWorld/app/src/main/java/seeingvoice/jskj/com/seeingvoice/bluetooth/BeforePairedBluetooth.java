 ...
 * auther:zyy
 */
public class BeforePairedBluetooth extends MyTopBar implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_start_search_bluetooth:
                skipAnotherActivity(this, SearchSVEarbudsL.class);
                break;
        }
    }
                    ...
                    .setPositiveButton("R.string.setting",
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    startActivityForResult(intent, MyData.NOT_NOTICE);
                                }
                            })
                    .setCancelable(false)
                    .show();
