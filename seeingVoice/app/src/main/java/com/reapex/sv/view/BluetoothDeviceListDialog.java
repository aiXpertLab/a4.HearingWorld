...
import com.reapex.sv.adapter.BluetoothDeviceListItemAdapter;
...
//                        App.myApplication.setBindMacDevice(mAddresses.get(position));
                    mListener.onBluetoothDeviceSelected(L_CommonUtil.getAdapter(mContext).getRemoteDevice(mAddresses.get(position)));
                    dialog.cancel();
                }
            });
        }
