...
import com.reapex.sv.App;
import com.reapex.sv.R;
import com.reapex.sv.base.BaseActivity;
import com.reapex.sv.base.ServerDataResponse;
import com.reapex.sv.bean.AppUpdateBean;
import com.reapex.sv.bean.AppUpdateOutBean;
...
import com.reapex.sv.util.UpdateManager;
import com.reapex.sv.util.Urls;
import com.reapex.sv.view.SelfDialog;
import com.lzy.okgo.OkGo;
import com.lzy.okgo.model.Response;

import androidx.annotation.Nullable;

import static com.reapex.sv.constants.Constances.NO_NEED_TO_UPDATE;
import static com.reapex.sv.constants.Constances.OKGO_ON_ERROR;
    ...
    public void processHandlerMessage(Message msg) {
        switch (msg.what){
            ...
            case NO_NEED_TO_UPDATE:
                L_CommonUtil.showToast(SettingActivity.this,"当前已经是最新版本。");
                break;
            default:
                break;
        }
    ...
    public void updateApp(AppUpdateBean bean){
        ...
        if (code != serviceCode && code < serviceCode) {
            SPHelper.getInst().saveString("downLoadUrl", downLoadUrl);
                selfDialog = new SelfDialog(SettingActivity.this, com.reapex.sv.R.style.dialog, updateDes);
                selfDialog.show();
