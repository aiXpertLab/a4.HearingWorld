...
//        ButterKnife.bind(this);
    ...
    public void processHandlerMessage(Message msg) {
        switch (msg.what){
            ...
            case FEEDBACKSUCCESS:
                L_CommonUtil.showToast(FeedbackActivity.this,"意见提交成功。");
                finish();
                break;
            default:
                break;
    ...
    public void checkValidate(){
        ...
        if(feedbackStr == null || feedbackStr.equals("")){
            L_CommonUtil.showToast(FeedbackActivity.this,"请输入您宝贵的意见再点击提交。");
            return ;
        }
        feedbackHttp();
    }
                ...
                .execute(new JsonCallback<ServerDataResponse<Object>>() {
                    ...
                    public void onSuccess(Response<ServerDataResponse<Object>> response) {
                        if (L_CommonUtil.isHttpSuccess(response.body().message_code)) {
                            ...
                            L_LogUtils.d(TAG, "反馈意见成功");
                        } else {
                            L_LogUtils.d(TAG, "反馈意见失败");
