...
import com.reapex.sv.constants.Constances;
import com.reapex.sv.event.GlassesOrderEvent;
import com.reapex.sv.service.NotificationService;
...
//        NetworkInfo info = connManager.getActiveNetworkInfo();
        ...
        int mState = NetType.NET_UNCONNECTED;

        Network[] allNetworks = connManager.getAllNetworks(); // added in API 21 (Lollipop)
        ...
        if (mState == NetType.NET_UNCONNECTED){
            return mState;
        }
    ...
    public static boolean hasNet(){
        return IsHaveInternet(App.myApplication) != NetType.NET_UNCONNECTED;
    }
