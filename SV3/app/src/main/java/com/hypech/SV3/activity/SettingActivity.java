package com.hypech.SV3.activity;
...
import com.hypech.SV3.base.BaseActivity;
...
import static com.hypech.SV3.constants.Constances.NO_NEED_TO_UPDATE;
import static com.hypech.SV3.constants.Constances.OKGO_ON_ERROR;
    ...
    public void updateApp(AppUpdateBean bean){
        ...
        if (code != serviceCode && code < serviceCode) {
            SPHelper.getInst().saveString("downLoadUrl", downLoadUrl);
                selfDialog = new SelfDialog(SettingActivity.this, com.hypech.SV3.R.style.dialog, updateDes);
                selfDialog.show();
