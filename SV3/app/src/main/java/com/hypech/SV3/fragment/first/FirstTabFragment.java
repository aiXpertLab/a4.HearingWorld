package com.hypech.SV3.fragment.first;
...
import com.hypech.SV3.App;
import com.hypech.SV3.activity.ScanMacCaptureActivity;
import com.hypech.SV3.base.BaseMainFragment;
import com.hypech.SV3.base.ServerDataResponse;
import com.hypech.SV3.bean.AppUpdateBean;
import com.hypech.SV3.bean.AppUpdateOutBean;
import com.hypech.SV3.bean.GlassesUpdateBean;
import com.hypech.SV3.bean.GlassesUpdateOutBean;
import com.hypech.SV3.bean.MessagequeueBaseBean;
import com.hypech.SV3.bean.MessagequeueBean;
import com.hypech.SV3.bean.MessagequeueFileBean;
import com.hypech.SV3.callback.JsonCallback;
import com.hypech.SV3.event.BindMacChangeEvent;
import com.hypech.SV3.event.ConnectEvent;
import com.hypech.SV3.event.GlassesOrderEvent;
import com.hypech.SV3.event.NoNetWorkEvent;
import com.hypech.SV3.event.TabSelectedEvent;

import org.greenrobot.eventbus.Subscribe;
import org.greenrobot.eventbus.ThreadMode;

import me.yokeyword.eventbusactivityscope.EventBusActivityScope;
import com.hypech.SV3.R;
import com.hypech.SV3.util.CommonUtil;
import com.hypech.SV3.util.ConvertData;
import com.hypech.SV3.util.LogUtils;
import com.hypech.SV3.util.SPHelper;
import com.hypech.SV3.util.TDevice;
import com.hypech.SV3.util.UpdateManager;
import com.hypech.SV3.util.Urls;
import com.hypech.SV3.view.BatteryView;
import com.hypech.SV3.view.BluetoothDeviceListDialog;
import com.hypech.SV3.view.SelfDialog;
import com.hypech.SV3.view.SelfDialogMacBind;
import com.hypech.SV3.view.SelfDialogconnectFaild;
import com.hypech.SV3.xunfeiutil.WebIATWS;
import com.hypech.SV3.xunfeiutil.xunfeiMessageEvent;
...
import static com.hypech.SV3.constants.Constances.*;
import static com.hypech.SV3.util.BleMsgUtil.*;
...
//弹出listdialog选择绑定设备
    ...
    private void initView(View view) {
        ...
        dialog.setTitle(com.hypech.SV3.R.string.paired_devices);
...
//        setupTimeout();
        ...
        status = close_status;
        //重新连接dialog
         connectFaildDialog = new SelfDialogconnectFaild(_mActivity, com.hypech.SV3.R.style.dialog, "眼镜连接失败","请检查眼镜设备电源是否打开");
         macBindDialog = new SelfDialogMacBind(_mActivity, com.hypech.SV3.R.style.dialog, "请输入设备号","");
    ...
    public void updateApp(AppUpdateBean bean){
        ...
        if (code != serviceCode && code < serviceCode) {
            ...
            if (isFirst || isForceUpdate.equals("1")) {
                selfDialog = new SelfDialog(_mActivity, com.hypech.SV3.R.style.dialog, updateDes);
                selfDialog.show();
