...
import com.reapex.sv.activity.dialog.L_RecordDialog;

import java.util.ArrayList;
import java.util.List;

public class Main_Asr extends AppCompatActivity implements View.OnClickListener {
    ...
    private L_SpeechRecognizerManager mSpeechManager;

    private TextView mTvRecordResult_sv;
    ...
    private L_RecordDialog mRecordDialog;
    ...
    private void initUI() {
        findViewById(R.id.icon_record_sv).setOnClickListener(this);
        ...
        mTvRecordResult_sv = findViewById(R.id.textview_record_result_sv);

        tvLanguage = findViewById(R.id.languagetext);
        tvType = findViewById(R.id.typetext);
        mRecordDialog = new L_RecordDialog(this, L_RecordDialog.TYPE_WITHOUT_COMPLETE_BUTTON);
        mRecordDialog.setOnBackPressedListener(new L_RecordDialog.OnBackPressedListener() {
            @Override
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.icon_record_sv) {
            ...
            //sv changeUi(View.VISIBLE, View.INVISIBLE);
                ...
                case MLAsrCaptureConstants.ASR_SUCCESS:
                    if (data != null) {
                        ...
                        if (text != null && !"".equals(text)) {
                            changeUi(View.INVISIBLE, View.VISIBLE);
                            mTvRecordResult_sv.setText(text+"onAcitivityResult");
                        }
                    }
                    break;
    ...
    private void startListening() {
        mSpeechManager = new L_SpeechRecognizerManager(this, mLanguage, listener);
    ...
    private class OnResultListener implements L_SpeechRecognizerManager.OnResultsReadyInterface {
        @Override
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode != this.PERMISSION_REQUESTS) {
            return;
        }
            ...
            androidx.appcompat.app.AlertDialog dialog = new androidx.appcompat.app.AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(this.getString(R.string.settings), new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            intent.setData(Uri.parse("package:" + Main_Asr.this.getPackageName()));
                            Main_Asr.this.startActivityForResult(intent, 200);
                            Main_Asr.this.startActivity(intent);
                        }
                    })
                    .setNegativeButton(this.getString(R.string.cancel), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Main_Asr.this.finish();
                        }
                    }).create();
            dialog.show();
        }
