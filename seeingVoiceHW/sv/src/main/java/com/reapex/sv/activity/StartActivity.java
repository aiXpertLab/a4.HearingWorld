...
import com.reapex.sv.activity.adapter.GridViewAdapter;
import com.reapex.sv.Main_Asr;
import com.reapex.sv.activity.entity.GridViewItem;
//import com.reapex.sv.activity.translate.TranslateActivity;
...
public final class StartActivity extends BaseActivity
    ...
    private void initClickEvent() {
        ...
        this.mGridView.setOnItemClickListener((parent, view, position, id) -> {
            switch (position) {
                case 1:
                    startActivity(new Intent(StartActivity.this, Main_Asr.class));
                    break;
            }
        });
    }
