...
package com.reapex.sv.activity.aft;
...
import com.reapex.sv.record.AudioManager;
import com.reapex.sv.record.RecordingListener;
import com.reapex.sv.util.FileUtils;
import com.reapex.sv.util.UriFileInfoUtils;
...
public class AudioFileTranscriptionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvRecordResult = findViewById(R.id.textview_record_result_sv);
    ...
    private void registerRecordingListener() {
        mRecordDialog = new L_RecordDialog(this, L_RecordDialog.TYPE_WITH_COMPLETE_BUTTON);
        mRecordDialog.setOnCompleteListener(new L_RecordDialog.OnCompleteListener() {
            @Override
