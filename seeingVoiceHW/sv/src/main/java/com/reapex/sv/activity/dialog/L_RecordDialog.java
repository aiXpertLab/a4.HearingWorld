...
package com.reapex.sv.activity.dialog;
...
import com.reapex.sv.util.CommonUtils;
...
public class L_RecordDialog extends Dialog {
    ...
    public L_RecordDialog(@NonNull Context context, int type) {
    ...
    private L_RecordDialog(@NonNull Context context, int themeResId, int type) {
