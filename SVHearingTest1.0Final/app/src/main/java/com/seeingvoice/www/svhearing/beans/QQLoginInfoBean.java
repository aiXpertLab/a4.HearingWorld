 ...
 * auther:zyy
 */
public class QQLoginInfoBean extends BaseBean implements Parcelable {
    /**
     * message_code : A000000
     * error_code :
     * error_info :
     * data : {"user_info":[{"uid":120,"user_openid":"openid","user_name":"gzfff","user_sex":1,"user_tel":"","user_age":"","user_headimgurl":"","user_province":"","user_city":"","user_country":"","is_verify_tel":""}]}
     */
    ...
    private QQLoginInfoBean(Parcel in) {
    ...
    public static final Creator<QQLoginInfoBean> CREATOR = new Creator<QQLoginInfoBean>() {
        @Override
        public QQLoginInfoBean createFromParcel(Parcel in) {
            return new QQLoginInfoBean(in);
        }
    ...
    public static class DataBean implements Parcelable {
        ...
        public static class UserInfoBean implements Parcelable {
            ...
            public void writeToParcel(Parcel dest, int flags) {
                ...
                dest.writeString(is_verify_tel);
            }
        }
    }
}
