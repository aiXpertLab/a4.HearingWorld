...
public class BackgourndAnimationRelativeLayout extends RelativeLayout {
    ...
    private final int DURATION_ANIMATION = 500;//动画时长
    private final int INDEX_BACKGROUND = 0;//背景索引
    private final int INDEX_FOREGROUND = 1;//前景索引
    /**
