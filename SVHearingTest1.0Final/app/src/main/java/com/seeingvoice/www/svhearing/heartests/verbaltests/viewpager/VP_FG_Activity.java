package com.seeingvoice.www.svhearing.heartests.verbaltests.viewpager;
...
import com.seeingvoice.www.svhearing.heartests.verbaltests.BroadCastManager;
...
public class VP_FG_Activity extends TopBarBaseActivity {
    public static VP_FG_Activity instance = null;
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        setToolBarMenuTwo("", R.mipmap.jiaocheng, new OnMenuClickListener() {
            ...
            public void onMultiClick(MenuItem v) {
                toNextActivity(null,VP_FG_Activity.this, AboutUsActivity.class);
            }
        });
    ...
    class VP_FG_Receiver extends BroadcastReceiver {
        ...
        private void speakout(final int flag) {
            mTextToSpeech = new TextToSpeech(VP_FG_Activity.this, new TextToSpeech.OnInitListener() {
                @Override
        ...
        private void initFragments() {
            ...
            viewPager.addOnPageChangeListener(new PageIndicator(VP_FG_Activity.this, dotHorizontal, 4));
        }
