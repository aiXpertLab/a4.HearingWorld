 ...
 * auther:zyy
 */
public class TelLoginBean extends BaseBean implements Parcelable{
    /**
     * message_code : A000000
     * error_code :
     * error_info :
     * data : {"user_info":[{"uid":119,"user_openid":"","user_name":"GZF","user_sex":1,"user_tel":"18406554525","user_age":22,"user_headimgurl":"","user_province":"","user_city":"","user_country":"","is_verify_tel":1}]}
     */
    ...
    protected TelLoginBean(Parcel in) {
    ...
    public static final Creator<TelLoginBean> CREATOR = new Creator<TelLoginBean>() {
        @Override
        public TelLoginBean createFromParcel(Parcel in) {
            return new TelLoginBean(in);
        }

        @Override
        public TelLoginBean[] newArray(int size) {
            return new TelLoginBean[size];
        }
    };
