...
public class PureTestResultBean implements Parcelable {
    ...
    public PureTestResultBean(int user_id, String user_IMEI,  String timeStamp, String l_average, String r_average,String remark, List<String> l_result, List<String> r_result) {
    ...
    private PureTestResultBean(Parcel in) {
        user_id = in.readInt();
    ...
    public static final Creator<PureTestResultBean> CREATOR = new Creator<PureTestResultBean>() {
        @Override
        public PureTestResultBean createFromParcel(Parcel in) {
            return new PureTestResultBean(in);
        }

        @Override
        public PureTestResultBean[] newArray(int size) {
            return new PureTestResultBean[size];
        }
    };
