...
import com.seeingvoice.www.svhearing.history.HistoryItemDetail;
...
import com.seeingvoice.www.svhearing.history.adapter.RecycleViewAdapter;
...
import static com.seeingvoice.www.svhearing.AppConstant.URL_DELETE_PURE_TEST_RESULT_URL;
...
//                Log.e(TAG,"请求失败的时候执行的方法"+request.toString());
...
//                                    ToastUtil.showLongToastCenter("错误："+pureHistoryBean.getError_info());
                        ...
                        String errorCode = pureHistoryBean.getError_code();
//                        if (errorCode.equals("E100202"))
//                        ToastUtil.showLongToast("网络错误,请重新访问");
                        ToastUtil.showLongToastCenter("网络错误，稍后再试！错误："+pureHistoryBean.getError_info());
