...
import com.seeingvoice.www.svhearing.heartests.verbaltests.numKeyboard.NumKeyboardActivity;
import com.seeingvoice.www.svhearing.heartests.verbaltests.ui.CustomVolumeControlBar;
...
//    private RelativeLayout mRL;
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final Intent intent = new Intent(getActivity(),NumKeyboardActivity.class);
            ...
            case 2:
                ...
                customVolumeControlBar.setOnVolumeChangeListener(new CustomVolumeControlBar.OnVolumeChangeListener() {
                    ...
                    public void OnVolumeChange() {
                        ...
                        MyApplication.setVerbal_music_volume(volumeValue);
                    }
                });
                break;
            case 3:
