...
import com.seeingvoice.www.svhearing.heartests.puretest.view.OnCountDownListener;
import com.seeingvoice.www.svhearing.heartests.puretest.view.PlayingPanelView;
...
public class HearingThreshold extends TopBarBaseActivity implements View.OnClickListener{
    ...
    public playingThreadtest mPlaySinSoundThread;
...
//    }
    ...
    private void toResult() {    //测试完成进入结果页面
        ...
        /* 送数据到结果页面*/
        Intent intent = new Intent(HearingThreshold.this, ResultActivity.class);
...
//        finishedToResult(intent);
    ...
    private void startPureTonePlaying(int hzValue, int dBValue,boolean Left) {
        ...
        mPlaySinSoundThread = new playingThreadtest(Left,hzValue,dBValue);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_one:
                ShareUtil.getInstance().shareFunction(HearingThreshold.this);
                break;
