package com.seeingvoice.www.svhearing.blueTest.battery;
...
public class MyBatterView extends View {
    ...
    private int power = 0;//当前电量（满电100）
...
//        typeFace = Typeface.createFromAsset(context.getAssets(), "fonts/" + Datas.logoFont);
        ...
        powerColor = typedArray.getColor(R.styleable.MyBatteryView_powerColor, Color.argb(255, 63, 188, 237));
        lowPowerColor = typedArray.getColor(R.styleable.MyBatteryView_lowPowerColor, Color.argb(255, 255, 0, 0));
        isShowText = typedArray.getBoolean(R.styleable.MyBatteryView_showText, true);
        isLeft = typedArray.getBoolean(R.styleable.MyBatteryView_isLeft, true);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e("电量VIew","specWidthSize:" + specWidthSize);
        Log.e("电量VIew","specHeightSize:" + specHeightSize);
...
//            Log.e("电量VIew","textWidth：" + textWidth);
