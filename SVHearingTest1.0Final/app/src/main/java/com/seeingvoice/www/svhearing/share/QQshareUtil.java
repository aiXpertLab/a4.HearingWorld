...
import static com.seeingvoice.www.svhearing.AppConstant.URL_DOWNLOAD_URL;
...
public class QQshareUtil {
    ...
    public static void qqShareFriends(Activity activity,QQ_SHARE_TYPE type) {
        ...
        params.putString(QQShare.SHARE_TO_QQ_APP_NAME, "见声听见APP");
...
//    }
    ...
    public static void qqQzoneShare(Activity activity) {
        ...
        params.putString(QzoneShare.SHARE_TO_QQ_TITLE, "见声听见APP官网");//分享标题
