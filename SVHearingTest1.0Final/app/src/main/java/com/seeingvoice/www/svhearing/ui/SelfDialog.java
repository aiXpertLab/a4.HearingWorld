package com.seeingvoice.www.svhearing.ui;
...
public class SelfDialog extends Dialog {
    ...
    private TextView selfMSG,selfTilte;
    private Button yes, no;
    private String versonMSG,strTitle="";
    ...
    public SelfDialog(Context context, int themeResId , String versonMSG,String title) {
        super(context, themeResId);
        this.versonMSG=versonMSG;
        this.strTitle = title;
    }
    ...
    private void initView() {
        ...
        selfTilte = findViewById(R.id.self_tv_title);
        if (!strTitle.equals("")){
            selfTilte.setText(strTitle);
        }
